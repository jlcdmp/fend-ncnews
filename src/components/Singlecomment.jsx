    ...
    return (
      ...
      <div className="commentstore">
        ...
        <div className='action' >
          <button className='vote-button' type='button' onClick={() => this.handleVoteClick(1)} >
          ...
          <p className='votes'>{voteChange}</p>
          <button className='vote-button' type='button' onClick={() => this.handleVoteClick(-1)} >
