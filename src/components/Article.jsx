      ...
      <div className='page4'>
        ...
        <div className='store'>
          ...
          <div className='panel-store' >
            ...
            <div className='votes' >
              <p className="votes-p" >{voteChange} votes</p>
            </div>
            ...
            <div className='panel'>
              ...
              <button className='toggle' type='button' onClick={this.handleCommentClick} >
                <svg
                  width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M24 20h-3v4l-5.333-4h-7.667v-4h2v2h6.333l2.667 2v-2h3v-8.001h-2v-2h4v12.001zm-15.667-6l-5.333 4v-4h-3v-14.001l18 .001v14h-9.667zm-6.333-2h3v2l2.667-2h8.333v-10l-14-.001v10.001z" /></svg>
              </button>
